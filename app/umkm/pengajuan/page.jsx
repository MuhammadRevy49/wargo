        ...
        <SidebarUmkm>
            <div className="min-h-screen bg-gray-50 p-4 sm:p-6 pt-16">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-xl mb-6 text-green-700 text-center"><span className="text-gray-800">Pengajuan</span> Anda</h1>
                    ...
                    <div className="bg-white shadow-md rounded-xl overflow-hidden">
                        <div className="bg-green-600 text-white px-4 py-2">Daftar Pengajuan Anda</div>
